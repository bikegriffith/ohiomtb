...
<div data-role="page" data-theme="a" id="demo-page" class="my-page">
	...
	<div data-role="header">
		<h1>OhioMTB Trail Conditions<?=$tab=='recent' ? ': Recent Updates' : ''?></h1>
	</div><!-- /header -->
	...
	<div data-role="navbar" data-iconpos="left">
		<ul>
			...
			<li><a href="/recent-updates" data-icon="gear" <?=$tab=='recent' ? 'class="ui-btn-active"' : ''?>>Recently Updated</a></li>
			<!--<li><a href="javascript:alert('Coming Soon!')" data-icon="star">My Favorites</a></li>-->
			<li><a href="/about" data-icon="info">About OhioMTB</a></li>
